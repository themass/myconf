...
class VideoUserParse(BaseParse):
    ...
    def run(self):
        ...
        print 'nvnvzx user video -- channel ok;,len=',len(chs)
        dbVPN.commit()
        dbVPN.close()
        for item in chs:
...
if __name__ == '__main__':
    pares = VideoUserParse()
    print pares.parseDomVideo("/?m=vod-play-id-31070-src-1-num-1.html")