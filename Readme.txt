...
cd Python-2.7.10
./configure --prefix=/home/work/local/python2.7.10/
make && make install

cd /home/work/local/
rm python2.7
ln -s python2.7.10 python2.7
echo 'export PYTHONE_HOME=/home/work/local/python2.7' >> ~/.bash_profile
echo 'export PATH=$PYTHONE_HOME/bin:/$PATH'  >> ~/.bash_profile
echo 'export PYTHONPATH=/home/work/server/python-script'  >> ~/.bash_profile
source ~/.bash_profile
...
cd /home/work/local/python2.7/bin
...
#sudo ln -s /home/work/install/mysql-5.6.10-linux-glibc2.5-x86_64/lib/libmysqlclient.so /usr/lib/libmysqlclient.so.18
