...
maxCount = 3
regVideo = re.compile(r"unescape('http(.*?)\.m3u8');")
...
class BaseParse(threading.Thread):
    ...
    def fetchUrl(self, url, aheader=header):
        ...
        while count < maxCount:
            try:
                req = urllib2.Request(baseurl + url, headers={'Cookie':"PHPSESSID=80sl6jm7rjoi4rba90118hfou3; Hm_lvt_fc6aae39f3014b53fa0ea14b92e76beb=1543754782; Hm_lpvt_fc6aae39f3014b53fa0ea14b92e76beb=1543755792"
