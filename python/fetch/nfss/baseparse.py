...
baseurl2 = "http://www.169afaf.com/"
baseurl3 = "http://www.asy3333.com/"
baseurl4 = "https://www.1123ou.com"
baseurl5 = "http://www.tlula44.com"
header2 = {'User-Agent':
...
header4 = {'User-Agent':
          ...
          "Cookie":"__cfduid=dc5907eba9410881f49adea935e4d00731601734490; Hm_lvt_66d9069fbd96fb79520d6a3fb00a601c=1601734427; Hm_lpvt_66d9069fbd96fb79520d6a3fb00a601c=1601735371"}
    ...
    def fetchUrlWithBase(self, url, aheader=header):
        ...
        while count < maxCount:
            try:
                ...
                content = response.read().decode('utf8', errors='replace').replace("<![endif]-->","").replace("<!--[if lt IE 9]>", "").replace("<![endif]-->", "").replace("<!--[if lt IE 9 ]>","").replace("<![endif]-->","")
#                 print content
                soup = BeautifulSoup(content)
                return soup
