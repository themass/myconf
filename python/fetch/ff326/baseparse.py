...
import re
import os
baseurl = "http://217ci.com"
header = {'User-Agent':
          'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.84 Safari/537.36', "Referer": baseurl}
maxCount = 3
regVideo = re.compile(r"http(.*)m3u8'")
iframeVideo = re.compile(r"videourl(.*)\.htm")
iframeVideo2 = re.compile(r'videourl(.*?)"')

playVideo = re.compile(r"varvHLSurl=(.*)\(\"(.*)\.m3u8")
#http://www.561aa.com/htm/mp4list6/  是一家网站么？？？？？
urlMap = {"javbox":"https://m3u8.299du.com/m3u8/javbox_water_m3u8_500","jav":"https://bojav.121yy.com/m3u8/jav-m3u8","kele":"https://bok9.121yy.com/m3u8/vod_water_m3u8/","lao":"https://bolao.121yy.com/m3u8"}
