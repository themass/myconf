...
class BaseParse(threading.Thread):
    ...
    def fetchUrl(self, url):
        ...
        while count < maxCount:
            try:
                req = urllib2.Request(url, headers={"Cookie": "zenid=b227c2098ac37d540e4579fb024e9ba9; __utma=62982011.325664695.1514618636.1514618636.1514618636.1; __utmc=62982011; __utmz=62982011.1514618636.1.1.utmcsr=seqing.one|utmccn=(referral)|utmcmd=referral|utmcct=/2059.html; __atuvc=7%7C52; __utmb=62982011.35.10.1514618636",
